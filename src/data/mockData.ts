...
export const mockData: MicroRegionData[] = [
  ...
  },
  {
    ...
    municipios: "Capelinha, Aricanduva, Berilo, Carbonita, Chapada do Norte, Francisco Badaró, Itamarandiba, Jenipapo de Minas, José Gonçalves de Minas, Leme do Prado, Minas Novas, Turmalina, Veredinha",
    macro_micro: "Micro - Capelinha",
